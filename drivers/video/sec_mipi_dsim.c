...
#include "../../board/keithkoep/common/kuk_boards.h"
...
static void bx5_init(void)
{
	...
	char i2c_telegram[10] = { 0x29, 0x05, 0x01, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	
	// Generated by SECO_ATM0700L61-CT18_U-Boot.xlsm (18.08.2022 16:16:20)
	struct Addr_data { int addr; int data } Vx_addr_data[] = {
	0x700 , 0x6C000040 ,
	0x704 , 0x3009A ,
	0x70C , 0x00004604 ,
	0x710 , 0x00CD000B ,
