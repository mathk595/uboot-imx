...
#define ASSUME_TRIZEPS8MINI_V1R2_1GB 1
#endif
...
#endif
#ifdef CONFIG_TRIZEPS8MINI_V1R3_1GB
#define ASSUME_TRIZEPS8MINI_V1R3_1GB 1
#endif
#ifdef CONFIG_TRIZEPS8MINI_V1R3_2GB
#define ASSUME_TRIZEPS8MINI_V1R3_2GB 1
#endif
#ifdef CONFIG_TRIZEPS8MINI_V1R3_4GB
#define ASSUME_TRIZEPS8MINI_V1R3_4GB 1
#endif

#ifdef CONFIG_TRIZEPS8NANO_V1R2_1GB
#define ASSUME_TRIZEPS8NANO_V1R2_1GB 1
#endif

#ifdef CONFIG_SBCSOM8MINI_V1R1_1GB
#define ASSUME_SBCSOM8MINI_V1R1_1GB 1
#endif
#ifdef CONFIG_SBCSOM8MINI_V1R1_2GB
#define ASSUME_SBCSOM8MINI_V1R1_2GB 1
#endif
#ifdef CONFIG_SBCSOM8MINI_V1R1_4GB
#define ASSUME_SBCSOM8MINI_V1R1_4GB 1
#endif

#ifdef CONFIG_TANARO_V1R1_1GB
#define ASSUME_TANARO_V1R1_1GB 1
#endif
#ifdef CONFIG_TANARO_V1R1_2GB
#define ASSUME_TANARO_V1R1_2GB 1
#endif
#ifdef CONFIG_TANARO_V1R1_4GB
#define ASSUME_TANARO_V1R1_4GB 1
#endif
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TRIZEPS8MINI_V1R2_1GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_TRIZEPS8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_1GB
#define ASSUME__KUK_RAMSKEW             0
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R2
#define ASSUME__KUK_TEMPERATURERANGE    KUK_TEMPERATURERANGE_UNKNOWN
#define ASSUME__KUK_BOOTSTORAGE         KUK_BOOTSTORAGE_UNKNOWN
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TRIZEPS8MINI_V1R3_1GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_TRIZEPS8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_1GB
#define ASSUME__KUK_RAMSKEW             0
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R3
#define ASSUME__KUK_TEMPERATURERANGE    KUK_TEMPERATURERANGE_UNKNOWN
#define ASSUME__KUK_BOOTSTORAGE         KUK_BOOTSTORAGE_UNKNOWN
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TRIZEPS8NANO_V1R2_1GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_TRIZEPS8NANO
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_16BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_1GB
#define ASSUME__KUK_RAMSKEW             0
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R2
#define ASSUME__KUK_TEMPERATURERANGE    KUK_TEMPERATURERANGE_UNKNOWN
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TRIZEPS8MINI_V1R3_2GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_TRIZEPS8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_2GB
#define ASSUME__KUK_RAMSKEW             1
#warning "ASSUME_TRIZEPS8MINI_V1R3_2GB KUK_PCBREV_V1R3"
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R3
#define ASSUME__KUK_TEMPERATURERANGE    KUK_TEMPERATURERANGE_UNKNOWN
#define ASSUME__KUK_BOOTSTORAGE         KUK_BOOTSTORAGE_UNKNOWN
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TRIZEPS8MINI_V1R3_4GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_TRIZEPS8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_4GB
#define ASSUME__KUK_RAMSKEW             0
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_SBCSOM8MINI_V1R1_1GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_SBCSOM8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_1GB
#define ASSUME__KUK_RAMSKEW             0
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R1
...
#else
#ifdef ASSUME_SBCSOM8MINI_V1R1_2GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_SBCSOM8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_2GB
#define ASSUME__KUK_RAMSKEW             1
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_UNKNOWN
#else
#ifdef ASSUME_SBCSOM8MINI_V1R1_4GB
#define ASSUME__KUK_MODULE_TYPE         KUK_MODULE_SBCSOM8MINI
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_4GB
#define ASSUME__KUK_RAMSKEW             0
...
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_1V8
#else
#ifdef ASSUME_TANARO_V1R1_1GB
#define ASSUME__KUK_MODULE_TYPE         GUF_MODULE_TANARO
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_1GB
#define ASSUME__KUK_RAMSKEW             1
#define ASSUME__KUK_PCBREV              KUK_PCBREV_V1R1
...
#define ASSUME__PERIPHERAL_ETHERNET     KUK_ETHERNET_AR8031    
#define ASSUME__PERIPHERAL_WIRELESS     KUK_WIRELESS_NONE
#define ASSUME__PERIPHERAL_AUDIO        KUK_AUDIO_TAS2552
#define ASSUME__PERIPHERAL_MCU          KUK_MCU_NONE
#define ASSUME__PERIPHERAL_LVDS         KUK_LVDS_SN65DSI83
#define ASSUME__PERIPHERAL_FPGA         KUK_FPGA_NONE
#define ASSUME__PERIPHERAL_IOVOLTAGE    KUK_IOVOLTAGE_3V3
#else
#ifdef ASSUME_TANARO_V1R1_2GB
#define ASSUME__KUK_MODULE_TYPE         GUF_MODULE_TANARO
#define ASSUME__KUK_RAMWIDTH            KUK_RAMWIDTH_32BIT
#define ASSUME__KUK_RAMSIZE             KUK_RAMSIZE_2GB
#define ASSUME__KUK_RAMSKEW             1
...
enum KUK_MODULE_TYPE {
    ...
    KUK_MODULE_SBCSOM8MINI,
    KUK_MODULE_SBCSOM8NANO,
    GUF_MODULE_TANARO,
};
int kuk_GetModule( void);

#define MODULE_IS_MYON_TYPE(m)         (((m==KUK_MODULE_MYON2)       ||(m==KUK_MODULE_MYON2NANO))   ?1:0) 
#define MODULE_IS_TRIZEPS8MINI_TYPE(m) (((m==KUK_MODULE_TRIZEPS8MINI)||(m==KUK_MODULE_TRIZEPS8NANO))?1:0) 

#define ART_NO_MODULE0    0
#define ART_NO_MODULE1    1
#define ART_NO_PROCESSOR  2
#define ART_NO_RAMSIZE    3
#define ART_NO_PCBVER     4
#define ART_NO_TEMP       6
#define ART_NO_FPGA       7
#define ART_NO_IOVOLTAGE  7
#define ART_NO_PERIPHERAL 8
#define ART_NO_MYON_AUDIO 8
#define ART_NO_NETW       9
#define ART_NO_MYON_LVDS  9  
#define ART_NO_STORE     10
