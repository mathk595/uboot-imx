...
static iomux_v3_cfg_t const usb_pads[] = {
	IMX8MN_PAD_GPIO1_IO14__GPIO1_IO14 | MUX_PAD_CTRL(GPIO_PAD_CTRL),
	IMX8MN_PAD_GPIO1_IO12__GPIO1_IO12 | MUX_PAD_CTRL(GPIO_PAD_CTRL),	
};
...
static iomux_v3_cfg_t const camera_pads[] = {
    IMX8MN_PAD_GPIO1_IO03__GPIO1_IO3  | MUX_PAD_CTRL(GPIO_PAD_PU_CTRL),  // Pin 123 Cam Pwdn
	IMX8MN_PAD_GPIO1_IO06__GPIO1_IO6  | MUX_PAD_CTRL(GPIO_PAD_PU_CTRL),  // Pin 123 Cam nRST
};
...
static iomux_v3_cfg_t const fec1_nrst_pads[] = {
	IMX8MN_PAD_ENET_RX_CTL__ENET1_RGMII_RX_CTL | MUX_PAD_CTRL(0x91),
	IMX8MN_PAD_ENET_RD2__ENET1_RGMII_RD2       | MUX_PAD_CTRL(0x91),
	IMX8MN_PAD_ENET_RXC__ENET1_RGMII_RXC       | MUX_PAD_CTRL(0x91),
	IMX8MN_PAD_ENET_RD3__ENET1_RGMII_RD3       | MUX_PAD_CTRL(0x91),
	IMX8MN_PAD_ENET_RD0__ENET1_RGMII_RD0       | MUX_PAD_CTRL(0x91),	
	IMX8MN_PAD_ENET_RD1__ENET1_RGMII_RD1       | MUX_PAD_CTRL(0x91),
};
...
static iomux_v3_cfg_t const fec1_rst_pads[] = {
    IMX8MN_PAD_GPIO1_IO09__GPIO1_IO9           | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RX_CTL__GPIO1_IO24         | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RD2__GPIO1_IO28            | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RXC__GPIO1_IO25            | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RD3__GPIO1_IO29            | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RD0__GPIO1_IO26            | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	IMX8MN_PAD_ENET_RD1__GPIO1_IO27            | MUX_PAD_CTRL(GPIO_PAD_PD_CTRL),
	/*
	IMX8MN_PAD_ENET_MDC__ENET1_MDC	          | MUX_PAD_CTRL(	0x03),
	IMX8MN_PAD_ENET_MDIO__ENET1_MDIO           | MUX_PAD_CTRL(	0x03),
	IMX8MN_PAD_ENET_TD3__ENET1_RGMII_TD3       | MUX_PAD_CTRL(	0x1f),
	IMX8MN_PAD_ENET_TD2__ENET1_RGMII_TD2       | MUX_PAD_CTRL(	0x1f),
	IMX8MN_PAD_ENET_TD1__ENET1_RGMII_TD1       | MUX_PAD_CTRL(	0x1f),
	IMX8MN_PAD_ENET_TD0__ENET1_RGMII_TD0       | MUX_PAD_CTRL(	0x1f),
	IMX8MN_PAD_ENET_RD3__ENET1_RGMII_RD3       | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_RD2__ENET1_RGMII_RD2       | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_RD1__ENET1_RGMII_RD1       | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_RD0__ENET1_RGMII_RD0       | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_TXC__ENET1_RGMII_TXC       | MUX_PAD_CTRL(	0x1f),
	IMX8MN_PAD_ENET_RXC__ENET1_RGMII_RXC       | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_RX_CTL__ENET1_RGMII_RX_CTL | MUX_PAD_CTRL(	0x91),
	IMX8MN_PAD_ENET_TX_CTL__ENET1_RGMII_TX_CTL | MUX_PAD_CTRL(	0x1f),
	*/
};
...
/* Enable Uart4/Uart2 pre-set in imx8mn_bl31_setup.c bl31_early_platform_setup2() */
