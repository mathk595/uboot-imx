...
#ifndef __IMX8MN_TRIZEPS8NANO_H
#define __IMX8MN_TRIZEPS8NANO_H
...
#define JAILHOUSE_ENV \
	"jh_clk= \0 " \
	"jh_mmcboot=mw 0x303d0518 0xff; setenv fdt_file kuk-trizeps8nano-root.dtb;" \
		"setenv jh_clk clk_ignore_unused; " \
			   "if run loadimage; then " \
				   "run mmcboot; " \
			   "else run jh_netboot; fi; \0" \
	"jh_netboot=mw 0x303d0518 0xff; setenv fdt_file kuk-trizeps8nano-root.dtb; setenv jh_clk clk_ignore_unused; run netboot; \0 "
